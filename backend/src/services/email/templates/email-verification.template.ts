              ...
              <tr>
                <td style="padding: 36px 40px 40px;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                    <tbody><tr>
                      <td style="width:52px; height:52px; background-color:rgba(232,149,74,0.12); display: flex;
                        border-radius:9999px; text-align:center; vertical-align:middle;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#e8954a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="display:block; margin: 14px auto 0;">
                  ...
                  <p style="font-size:14px; color:#888; margin:0 0 28px; line-height:1.6;">
                    ...
                    thanks for signing up for Nexora! Please verify your email to activate your account.
                  </p>

                  <!-- Body text -->
                  <p style="font-size:14px; color:#a0a09a; margin:0 0 28px; line-height:1.7;">
                    Click the button below to verify your email address. This link is valid for
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                    <tbody><tr>
                      <td style="border-radius:10px; background-color:#d4782a;">
                        <a href="${escapeHtml(verificationLink)}" style="display:inline-block; padding:12px 28px;
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                    <tbody><tr>
                      <td style="background-color:rgba(255,255,255,0.04);
                        ...
                        <a href="${escapeHtml(verificationLink)}" style="font-size:12px; color:#e8954a; text-decoration:none;
                    ...
                    <tbody><tr>
                      ...
                      <td>
                        <p style="font-size:12px; color:#555; margin:0; line-height:1.6;">
                          ...
                          no account will be activated and no action is needed.
                        </p>
                      </td>
                    </tr>
                  </tbody></table>
